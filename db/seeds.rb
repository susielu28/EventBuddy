...
file = URI.open("https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/v1674661608/nwr2zrhvbdqdmjavgc8f.jpg")
user = User.new(
    first_name: 'Lukas',
    last_name: 'Noetzel',
    email: 'lukas.noetzel@example.com',
    gender: 'male',
    age: 34,
    bio: 'I am a software engineer who loves attending all sorts of events.',
    organizer: false,
    location: 'Berlin',
    password: '123456'
)
user.photo.attach(io: file, filename: "Lukas.png", content_type: "image/png")
user.save
